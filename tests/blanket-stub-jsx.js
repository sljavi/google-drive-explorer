...
module.exports = function(blanket) {
    ...
    require.extensions['.js'] = function(localModule, filename) {
        ...
        if (transformer.shouldStub(filename) || !blanket.matchPattern(normalizedFilename, pattern)) {
    ...
    glob.sync(pattern).forEach(function(aPath) {
        var pathFromRoot = aPath.slice(2);
